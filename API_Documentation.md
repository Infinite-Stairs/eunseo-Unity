...
```csharp
apiManager.SetBaseURL("https://gahuifunction.onrender.com");
```
...
const fetchRecentScores = async (limit = 10) => {
  try {
    const response = await fetch(
      `http://localhost:3000/api/scores/recent?limit=${limit}`,
      {
        method: "GET",
        headers: {
...
const fetchLeaderboard = async (limit = 100) => {
  try {
    const response = await fetch(
      `http://localhost:3000/api/scores/leaderboard?limit=${limit}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
const fetchCharacterStats = async () => {
  try {
    const response = await fetch(
      "http://localhost:3000/api/scores/character-stats",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
const fetchUserStats = async (userId) => {
  try {
    const response = await fetch(
      `http://localhost:3000/api/user/${userId}/stats`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
